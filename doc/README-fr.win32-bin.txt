systecash est un logiciel de comptabilité gratuit et de source
...
systecash permet le suivi des comptes bancaires, des titres, des
...
FAQ en ligne:		http://wiki.systecash.org/wiki/FAQ
Listes de diffusions:	http://wiki.systecash.org/wiki/Mailing_Lists
IRC (Chat):		Canal #systecash sur le serveur irc.gnome.org,
Aussi à consulter:		http://wiki.systecash.org/wiki/IRC
...
La programmation de systecash a commencé en 1997, sa première version
a été lancée en 1998.

-------------------

Ceci est le fichier README de systecash 2.2.x pour les paquetages en
