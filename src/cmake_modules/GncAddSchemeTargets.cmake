...
MACRO(GNC_ADD_SCHEME_TARGETS _TARGET _SOURCE_FILES _OUTPUT_DIR_IN _GUILE_MODULES _GUILE_LOAD_DIRS _GUILE_LIBRARY_DIRS _GUILE_DEPENDS_IN MAKE_LINKS_IN)
  ...
  IF(GNC_BUILD_AS_INSTALL)
    SET(_OUTPUT_DIR ${DATADIR_BUILD}/systecash/scm/${_OUTPUT_DIR_IN})
  ENDIF()
  ...
  IF(HAVE_GUILE2)
    ...
    IF(GNC_BUILD_AS_INSTALL)
      SET(_GUILE_CACHE_DIR ${LIBDIR_BUILD}/systecash/scm/ccache/2.0)
      SET(_GUILE_LOAD_PATH "${CMAKE_CURRENT_SOURCE_DIR}:${DATADIR_BUILD}/systecash/scm")
      SET(_GUILE_LOAD_COMPILED_PATH ${_GUILE_CACHE_DIR})
#      SET(_GNC_MODULE_PATH  "${LIBDIR_BUILD}/${CMAKE_BUILD_TYPE}:${LIBDIR_BUILD}/systecash/${CMAKE_BUILD_TYPE}")
      SET(_GNC_MODULE_PATH  "")
    ...
    FOREACH(source_file ${_SOURCE_FILES})
      ...
      ADD_CUSTOM_COMMAND(
        ...
        COMMAND ${CMAKE_COMMAND_TMP}
           ...
           LD_LIBRARY_PATH="${LIBDIR_BUILD}:${LIBDIR_BUILD}/systecash:${_GUILE_LD_LIBRARY_PATH}"
           DYLD_LIBRARY_PATH="${LIBDIR_BUILD}:${LIBDIR_BUILD}/systecash:${_GUILE_LD_LIBRARY_PATH}"
           GUILE_LOAD_PATH=${_GUILE_LOAD_PATH}
           GUILE_LOAD_COMPILED_PATH=${_GUILE_LOAD_COMPILED_PATH}
           #GNC_MODULE_PATH=${_GNC_MODULE_PATH}
           GNC_MODULE_PATH="${LIBDIR_BUILD}:${LIBDIR_BUILD}/systecash:${GNC_MODULE_PATH}"
