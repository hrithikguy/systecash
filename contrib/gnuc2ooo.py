...
#   
#   Makros for the download of systecash Data to OpenOffice.org Base
#
#   Makro SetsystecashFilePaths:
#       Set or change the filepaths of the (systecash) data source
#       and of the new OpenOffice.org database that will be created
#       in this makro though still empty
#
#   Makro fillsystecashDB:
#       Download data from the systecash data source to OpenOffice.org
#       Base
#   
#
#**********************************************************************
...
set_makro = "SetsystecashFilePaths"
settings_textentrance = "#This file was generated by OpenOfficeMakro: "
settings_textinp = "systecashDatafile: "
...
def settings_filepath():
    ...
    userfile = os.path.join(userdir, 'systecashFilePaths.txt')
    return userfile

def getGCFilename():
    global crout
    crout = 'getGCFilename'
    fp_read.Title = "Pick Output Data File of systecash Program"
...
def exec_SetsystecashFilePaths():
    ...
    MessageBox('A new Openoffice.org database has been created.\n' +
               'To fill with data please run makro "fillsystecashDB."',
               MsgType="infobox")  
...
def MessageBox(MsgText, MsgTitle="systecash to Ooo", MsgType="messbox", MsgButtons=OK, ParentWin=None):
    global crout
    crout = 'MessageBox'
...
def exec_fillsystecashDB():
    """Fill OpenOffice.org database with newest systecash data"""
    global crout
    crout = 'exec_fillsystecashDB'
...
def fillsystecashDB():
    global crout
    crout = 'fillsystecashDB'
    try:
        exec_fillsystecashDB()
    except Exception, args:
        issue_error_messages(args)
        return
    
def SetsystecashFilePaths():
    global crout
    crout = 'SetsystecashFilePaths'
    try:
        exec_SetsystecashFilePaths()
    except Exception, args:
        issue_error_messages(args)
        return
    
g_exportedScripts = fillsystecashDB, SetsystecashFilePaths, 
