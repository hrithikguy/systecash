...
static const gchar *encodings_doc_string = N_(
            ...
            "systecash. The file format in the older versions was missing the "
            ...
            "systecash 2.0.0 file format will include all necessary specifications so "
            "that you do not have to go through this step again."
            "\n\n"
            "systecash will try to guess the correct character encoding for your data "
            "file. On the next page systecash will show the resulting texts when "
