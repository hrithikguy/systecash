...
{
    return g_strdup("systecash/report/report-system");
}

char *
libgncmod_report_system_gnc_module_description(void)
{
    return g_strdup("Core components of systecash report generation system");
}
...
libgncmod_report_system_gnc_module_init(int refcount)
{
    ...
    scm_c_eval_string("(use-modules (systecash report report-system))");
